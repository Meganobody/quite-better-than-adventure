...
public class TileEntityRendererMeshSteelCrude extends TileEntityRenderer<TileEntityMeshSteelCrude> {
	public EntityItem renderEntity = new EntityItem(null);
	private Random rand = new Random();

	public void doRender(Tessellator tessellator, TileEntityMeshSteelCrude tileEntity, double x, double y, double z, float renderPartialTicks) {
