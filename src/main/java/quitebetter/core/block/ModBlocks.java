...
public class ModBlocks {
	...
	public static Block<?> ACTIVE_CONVEYOR;
	...
	public static void Setup() {
		int startingBlockId = 3000;
		//BONEBLOCK
		BLOCK_BONE = new BlockBuilder(MOD_ID)
			.setHardness(1.0F).setResistance(1.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("block_bone", startingBlockId++, b -> new BlockLogic(b, Material.marble) {});
		//OBSIDIAN POLISHED
		OBSIDIAN_POLISHED = new BlockBuilder(MOD_ID)
			.setHardness(20.0F).setResistance(2000.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("obsidian_polished", startingBlockId++, b -> new BlockLogic(b, Material.stone) {})
			.withOverrideColor(MaterialColor.paintedBlack);
		//SEASHELLTILES
		TILE_SEASHELL = new BlockBuilder(MOD_ID)
			.setHardness(1.5F).setResistance(2.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("tile_seashell", startingBlockId++, b -> new BlockLogic(b, Material.slate) {});
		STAIRS_TILE_SEASHELL = new BlockBuilder(MOD_ID)
			.setHardness(1.5F).setResistance(2.0F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("stairs_tile_seashell", startingBlockId++, b -> new BlockLogicStairs(b, TILE_SEASHELL) {});
		SLAB_TILE_SEASHELL = new BlockBuilder(MOD_ID)
			.setHardness(1.5F).setResistance(2.0F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("slab_tile_seashell", startingBlockId++, b -> new BlockLogicSlab(b, TILE_SEASHELL) {});
		//HAZARD
		HAZARD = new BlockBuilder(MOD_ID)
			...
			.build("hazard", startingBlockId++, b -> new BlockLogicHazard(b, Material.stone) {})
		...
		HAZARD_PAINTED = new BlockBuilder(MOD_ID)
			...
			.build("hazard_painted", startingBlockId++, b -> new BlockLogicHazardPainted(b, Material.stone) {});
		//FAN
		FAN = new BlockBuilder(MOD_ID)
			...
			.build("fan", startingBlockId++, b -> new BlockLogicFan(b, Material.wood, false, false) {});
		ACTIVE_FAN = new BlockBuilder(MOD_ID)
			...
			.build("active_fan", startingBlockId++, b -> new BlockLogicFan(b, Material.wood, true, false) {});
		IN_FAN = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(25.0F)
			.setTicking(true)
			.setTags(BlockTags.FENCES_CONNECT, BlockTags.MINEABLE_BY_PICKAXE, BlockTags.MINEABLE_BY_AXE, BlockTags.NOT_IN_CREATIVE_MENU)
			.build("in_fan", startingBlockId++, b -> new BlockLogicFan(b, Material.wood, false, true) {});
		ACTIVE_IN_FAN = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(25.0F)
			.setTicking(true)
			.setTags(BlockTags.FENCES_CONNECT, BlockTags.MINEABLE_BY_PICKAXE, BlockTags.MINEABLE_BY_AXE, BlockTags.NOT_IN_CREATIVE_MENU)
			.build("active_in_fan", startingBlockId++, b -> new BlockLogicFan(b, Material.wood, true, true) {});
		//OLIVINE BRICKS
		BRICK_OLIVINE = new BlockBuilder(MOD_ID)
			.setHardness(3F).setResistance(10.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("brick_olivine", startingBlockId++, b -> new BlockLogic(b, Material.stone) {});
		STAIRS_BRICK_OLIVINE = new BlockBuilder(MOD_ID)
			.setHardness(3F).setResistance(10.0F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("stairs_brick_olivine", startingBlockId++, b -> new BlockLogicStairs(b, BRICK_OLIVINE) {});
		SLAB_BRICK_OLIVINE = new BlockBuilder(MOD_ID)
			.setHardness(3F).setResistance(10.0F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("slab_brick_olivine", startingBlockId++, b -> new BlockLogicSlab(b, BRICK_OLIVINE) {});
		//CONVEYOR
		CONVEYOR = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(10.0F)
			.setTags(BlockTags.NOT_IN_CREATIVE_MENU)
			.build("conveyor", startingBlockId++, b -> new BlockLogicConveyor(b, Material.wood) {});
		ACTIVE_CONVEYOR = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(10.0F)
			.setTags(BlockTags.NOT_IN_CREATIVE_MENU)
			.build("active_conveyor", startingBlockId++, b -> new BlockLogicConveyor(b, Material.wood) {});
		//CACTUS B0ARDS
		SUPPORT_STEEL = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(1.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("support_steel", startingBlockId++, b -> new BlockLogicPillar(b, Material.steel) {});
		SUPPORT_IRON = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(1.0F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE)
			.build("support_iron", startingBlockId++, b -> new BlockLogicPillar(b, Material.metal) {});
		//GLOWING MUSHROOM
		MUSHROOM_GLOWING = new BlockBuilder(MOD_ID)
			.setTags(BlockTags.PLANTABLE_IN_JAR)
			.build("mushroom_glowing", startingBlockId++, b -> new BlockLogicGlowingMushroom(b) {}).withLightEmission(0.95F);
		//PEDESTAL
		PEDESTAL = new BlockBuilder(MOD_ID)
			.setTags(BlockTags.NOT_IN_CREATIVE_MENU)
			.build("pedestal", startingBlockId++, b -> new BlockLogicPedestal(b, Material.cloth) {});
		//SNOW BRICKS
		BRICK_SNOW = new BlockBuilder(MOD_ID)
			.setHardness(0.3F)
			.setTags(BlockTags.MINEABLE_BY_PICKAXE,BlockTags.MINEABLE_BY_SHOVEL)
			.build("brick_snow", startingBlockId++, b -> new BlockLogic(b, Material.snow) {});
		STAIRS_BRICK_SNOW = new BlockBuilder(MOD_ID)
			.setHardness(0.3F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE,BlockTags.MINEABLE_BY_SHOVEL)
			.build("stairs_brick_snow", startingBlockId++, b -> new BlockLogicStairs(b, BRICK_SNOW) {});
		SLAB_BRICK_SNOW = new BlockBuilder(MOD_ID)
			.setHardness(0.3F)
			.setUseInternalLight()
			.setTags(BlockTags.MINEABLE_BY_PICKAXE,BlockTags.MINEABLE_BY_SHOVEL)
			.build("slab_brick_snow", startingBlockId++, b -> new BlockLogicSlab(b, BRICK_SNOW) {});
		//ARROW TORCH BLOCK
		ARROW_TORCH = new BlockBuilder(MOD_ID)
			.setTags(BlockTags.NOT_IN_CREATIVE_MENU)
			.build("arrow_torch", startingBlockId++, b -> new BlockLogicArrowTorch(b) {}).withLightEmission(1F);
		//CRATE
		CRATE = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(25.0F)
			.build("crate", startingBlockId++, b -> new BlockLogicCrate(b, Material.wood) {});
		CRATE_PAINTED = new BlockBuilder(MOD_ID)
			.setHardness(1F).setResistance(25.0F)
			.setBlockItem(b -> new ItemBlockPainted(b, false))
			.build("crate_painted", startingBlockId++, b -> new BlockLogicCratePainted(b, Material.wood) {});
		//GEODE
		GEODE = new BlockBuilder(MOD_ID)
			.setHardness(10F).setResistance(25.0F)
			.build("geode", startingBlockId++, b -> new BlockLogicGeode(b, Material.basalt) {});
	}
}
